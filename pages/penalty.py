...
def record_penalties():
    try:
        ...
        penalties_excel_file = "F:\OneDrive\TubiStats\Penalty.xlsx"
...
def create_page(notebook):
    ...
    notebook.add(penalties_frame, text="Penalty")
    ...
    penalties_button = ttk.Button(penalties_frame, text="Confirm", command=record_penalties)
    penalties_button.grid(row=len(players.players), columnspan=2, padx=10, pady=10)
