...
def create_page(notebook):
    ...
    for player in player_data.players:
        ...
        assist_entry.grid(column=1, row=player_data.players.index(player), padx=10, pady=5, sticky=tk.E)

    # Button to record assists - Assists Page
    assists_button = ttk.Button(assists_frame, text="Record Assists", command=record_assists)
    assists_button.grid(column=0, row=len(player_data.players), columnspan=2, padx=10, pady=10)
